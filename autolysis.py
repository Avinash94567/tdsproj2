...
Original file is located at
    https://colab.research.google.com/drive/11keMtZ5aZujtjeZOkS7vg-a4OMw8DAbW
"""
...
AIPROXY_TOKEN = os.getenv('eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIyZjEwMDA3NTNAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.QIC_B8BCHPzLhqF2I0hMisNnlQ3BbgkjyWtmVc9m_-Y')  # Fetch token from environment variable
...
# Create a ZIP archive of the 'data_files' folder
shutil.make_archive('/content/media', 'zip', '/content/media')

# Download the ZIP file
files.download('/content/media.zip')